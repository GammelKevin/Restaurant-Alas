                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        checked={hour.vacation_active}
                        onChange={(e) => onChange('vacation_active', e.target.checked)}
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                      <span className="text-gray-700 dark:text-gray-300">Urlaub aktiviert</span>
                    </div>
                    {hour.vacation_active && (
