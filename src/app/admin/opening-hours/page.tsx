...
export default function AdminOpeningHoursPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const cleanedHour = {
        ...
        vacation_active: editingHour.vacation_active ? 1 : 0,
        ...
        vacation_start: editingHour.vacation_start || null,
        vacation_end: editingHour.vacation_end || null,
      };
  ...
  const formatTimeDisplay = (hour: OpeningHour): string => {
    // Handle boolean/number conversion for closed and vacation_active
    const isClosed = hour.closed === true || hour.closed === 1;
    const isOnVacation =
      hour.vacation_active === true || hour.vacation_active === 1;

    if (isClosed) return "Geschlossen";
    if (isOnVacation) return "Urlaub";
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Bearbeiten Sie die Öffnungszeiten und Urlaubszeiten
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <label className="flex items-center p-4 bg-gray-50 dark:bg-slate-700 rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-600 transition-colors">
                        <input
                          type="checkbox"
                          checked={
                            editingHour?.vacation_active === true ||
                            editingHour?.vacation_active === 1
                          }
                          onChange={(e) =>
                            handleFieldChange(
                              "vacation_active",
                          ...
                          className="w-5 h-5 text-orange-600 rounded focus:ring-orange-500 mr-3"
                        />
                        <span className="text-gray-700 dark:text-gray-300 font-medium">
                          <Palmtree className="w-5 h-5 inline mr-2" />
                          Urlaubsmodus
                        </span>
                      </label>
                    </div>
                    ...
                    {(editingHour?.vacation_active === true ||
                      ...
                      <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                        <label className="flex items-center text-sm font-medium text-gray-900 dark:text-gray-300 mb-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            ...
                            <JollyDatePicker
                              value={editingHour?.vacation_start ? parseDate(editingHour.vacation_start) : null}
                              onChange={(date) =>
                                handleFieldChange(
                                  "vacation_start",
                                  date?.toString(),
                          ...
                          <div>
                            ...
                            <JollyDatePicker
                              value={editingHour?.vacation_end ? parseDate(editingHour.vacation_end) : null}
                              onChange={(date) =>
                                handleFieldChange(
                                  "vacation_end",
                                  date?.toString(),
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="mt-2 flex items-center gap-3">
                            ...
                            {isOnVacation && (
                              <span className="inline-flex items-center px-3 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-sm rounded-full">
                                <Palmtree className="w-4 h-4 mr-1" />
                                Urlaub
                              </span>
                            )}
                            {!isClosed && !isOnVacation && (
                          ...
                          {isOnVacation &&
                            ...
                            hour.vacation_end && (
                              <p className="mt-2 text-sm text-orange-600 dark:text-orange-400">
                                ...
                                -{" "}
                                {new Date(hour.vacation_end).toLocaleDateString(
                                  "de-DE",
                                )}
                              </p>
                            )}
